...
@pytest.mark.parametrize("title,template_id,sms_text",excel_reader.get_data( "C:\\Final_Pytest\\pilot_project_Demo_smart_hospital_Pytest\\Demo_smart_hospital\ExcelReader\\test_data.xlsx","SendSMS"))
class TestSendSMS:
