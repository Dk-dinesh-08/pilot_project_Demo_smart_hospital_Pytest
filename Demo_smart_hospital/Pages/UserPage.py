...
class UserPage(BasePage):
    ...
    def test_next_page_button(self):
        try:
            ...
            log.error(f"Error in test_next_page_button: {str(e)}")
    ...
    def test_search_record(self, searchRecord):
        try:
            ...
            log.error(f"Error in test_search_record: {str(e)}")
    ...
    def click_user_appointment(self):
        try:
            ...
            log.error(f"Error in click_user_appointment: {str(e)}")
    ...
    def Assert_search_Appointment(self):
        try:
            ...
            log.error(f"Error in Assert_search_Appointment: {str(e)}")
    ...
    def Invalid_Assert_search_Appointment(self):
        try:
            ...
            log.error(f"Error in Invalid_Assert_search_Appointment: {str(e)}")
    ...
    def Click_usert_Add_appointment(self):
        try:
            ...
            log.error(f"Error in Click_usert_Add_appointment: {str(e)}")
    ...
    def Enter_Specialist(self):
        try:
            ...
            log.error(f"Error in Enter_Specialist: {str(e)}")
    ...
    def Enter_Doctor(self):
        try:
            ...
            log.error(f"Error in Enter_Doctor: {str(e)}")
    ...
    def Enter_shift(self):
        try:
            ...
            log.error(f"Error in Enter_shift: {str(e)}")
    ...
    def Enter_slot_feild(self):
        try:
            ...
            log.error(f"Error in Enter_slot_feild: {str(e)}")
    ...
    def Enter_Appointment(self):
        try:
            ...
            log.error(f"Error in Enter_Appointment: {str(e)}")
    ...
    def Enter_Message(self, message):
        try:
            ...
            log.error(f"Error in Enter_Message: {str(e)}")
    ...
    def Click_live_consultancy(self):
        try:
            ...
            log.error(f"Error in Click_live_consultancy: {str(e)}")
    ...
    def Alternative_address(self, Address):
        try:
            ...
            log.error(f"Error in Alternative_address: {str(e)}")
    ...
    def click_user_appointment_slot(self):
        try:
            ...
            log.error(f"Error in click_user_appointment_slot: {str(e)}")
    ...
    def successfull_search_by_bill_number(self):
        try:
            ...
            log.error(f"Error in successfull_search_by_bill_number: {str(e)}")
    ...
    def unsuccessfull_search_by_bill_number(self):
        try:
            ...
            log.error(f"Error in unsuccessfull_search_by_bill_number: {str(e)}")
    ...
    def verify_successfull_search_by_bill_number(self):
        try:
            ...
            log.error(f"Error in verify_successfull_search_by_bill_number: {str(e)}")
    ...
    def verify_unsuccessfull_search_by_bill_number(self):
        try:
            ...
            log.error(f"Error in verify_unsuccessfull_search_by_bill_number: {str(e)}")
    ...
    def successfull_view_of_bill_details(self):
        try:
            ...
            log.error(f"Error in successfull_view_of_bill_details: {str(e)}")
    ...
    def verify_successfull_view_bill_details(self):
        try:
            ...
            log.error(f"Error in verify_successfull_view_bill_details: {str(e)}")
    ...
    def Add_new_appointment_assert(self):
        try:
            ...
            log.error(f"Error in Add_new_appointment_assert: {str(e)}")

    def switch_to_payment_iframe(self):
        try:
            self._wait.until(EC.frame_to_be_available_and_switch_to_it(self.payment_frame))
        except Exception as e:
            log.error(f"Iframe with class name '{self.payment_frame[1]}' was not found within the timeout period: {str(e)}")
    ...
    def Click_User_payment_button(self):
        try:
            ...
            log.error(f"Error in Click_User_payment_button: {str(e)}")
    ...
    def click_pay_with_card(self):
        try:
            ...
            log.error(f"Error in click_pay_with_card: {str(e)}")
    ...
    def Enter_email(self, mailId):
        try:
            ...
            log.error(f"Error in Enter_email: {str(e)}")
    ...
    def Enter_card_number(self, Cardnum):
        try:
            ...
            log.error(f"Error in Enter_card_number: {str(e)}")
    ...
    def Enter_payment_month(self, month):
        try:
            ...
            log.error(f"Error in Enter_payment_month: {str(e)}")
    ...
    def Enter_payment_cvv(self, cvv):
        try:
            ...
            log.error(f"Error in Enter_payment_cvv: {str(e)}")
    ...
    def Enter_pincode(self, pincode):
        try:
            ...
            log.error(f"Error in Enter_pincode: {str(e)}")
    ...
    def click_pay_button_in_payment_page(self):
        try:
            ...
            log.error(f"Error in click_pay_button_in_payment_page: {str(e)}")
    ...
    def click_status_twice(self):
        try:
            ...
            log.error(f"Error in click_status_twice: {str(e)}")
    ...
    def click_delete_button(self):
        try:
            ...
            log.error(f"Exception occurred while clicking user appointment delete button: {e}")
    ...
    def total_count_of_bill_records_assert(self):
        try:
            ...
            log.error(f"Error in total_count_of_bill_records_assert: {str(e)}")
    ...
    def Empty_assert(self):
        try:
            ...
            log.error(f"Error in Empty_assert: {str(e)}")
