...
class BasePage:
    ...
    def for_send_keys(self, element, value):
        try:
            ...
            print(f"Exception occurred while sending keys: {e}")
    ...
    def wait_for_elements(self, locator):
        try:
            ...
            print(f"Exception occurred while waiting for elements: {e}")
            return None
    ...
    def click_Home_login_button(self):
        try:
            ...
            print(f"Exception occurred while clicking Home login button: {e}")

    def click_Admin_login_button(self):
        try:
            self.for_click(self.wait_for_element(self.Admin_login_button))
        except Exception as e:
            print(f"Exception occurred while clicking Admin login button: {e}")
    ...
    def click_Sign_in_button(self):
        try:
            ...
            print(f"Exception occurred while clicking Sign in button: {e}")

    def switch_to_window(self):
        try:
            self._driver.switch_to.window(self._driver.window_handles[1])
        except WebDriverException as e:
            print(f"Exception occurred while switching to window: {e}")

    def click_invalid_doctorlogin_button(self):
        try:
            self.for_click(self.wait_for_element(self.invalid_doctor_button))
        except Exception as e:
            print(f"Exception occurred while clicking invalid doctor login button: {e}")
    ...
    def clear_login_field(self):
        try:
            ...
            print(f"Exception occurred while clearing login fields: {e}")
    ...
    def fill_login_using_login_credentials(self, username, password):
        try:
            ...
            print(f"Exception occurred while filling login credentials: {e}")
    ...
    def verify_unsuccessfull_login_using_blank_username(self):
        try:
            ...
            print(f"Exception occurred while verifying unsuccessful login with blank username: {e}")
    ...
    def verify_unsuccessfull_login_using_blank_password(self):
        try:
            ...
            print(f"Exception occurred while verifying unsuccessful login with blank password: {e}")
    ...
    def verify_unsuccessfull_login_using_invalid_credentials(self):
        try:
            ...
            print(f"Exception occurred while verifying unsuccessful login with invalid credentials: {e}")

    def click_Admin_signin_button(self):
        try:
            self.for_click(self.wait_for_element(self.Admin_signin_button))
        except Exception as e:
            print(f"Exception occurred while clicking Admin sign in button: {e}")
    ...
    def select_element_by_visible_text(self, locator, text):
        try:
            ...
            print(f"Exception occurred while selecting element by visible text: {e}")
    ...
    def select_element_by_value(self, locator, text):
        try:
            ...
            print(f"Exception occurred while selecting element by value: {e}")
    ...
    def verify_admin_page_opens(self):
        try:
            ...
            print(f"Exception occurred while verifying admin page opens: {e}")
            return None
    ...
    def click_elefunction(self, element):
        try:
            ...
            print(f"Exception occurred while executing click script: {e}")
